...
const trainers: Trainer[] = [
  ...
  { id: 't4', name: 'Ivana Knežević', business: 'PetPark Dresura', city: 'Rijeka', rating: 4.8, reviewCount: 98, priceFrom: 20, bio: 'Certificirana bihevioristica. Individualni pristup, specijalizirana za velike pasmine.', specializations: ['Biheviorizam', 'Velike pasmine', 'Šetnja na povodniku', 'Štenci'], avatar: '🐕‍🦺', certified: true },
